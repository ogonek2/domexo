...
@section('seo')
    <title>Оплата — DOMEXO</title>
    <meta name="description" content="Способи оплати замовлень в інтернет-магазині DOMEXO: готівка, безготівковий розрахунок, банківська картка через LiqPay.">
@endsection
    ...
    <section class="bg-[#F5F6FB] py-4">
        <div class="max-w-site mx-auto px-4 sm:px-6 lg:px-8">
            <nav class="flex items-center space-x-2 text-sm">
                ...
                <span class="text-[#0B1F3B] font-medium">Оплата</span>
            </nav>
        </div>
    </section>
                ...
                <div class="lg:col-span-3">
                    <div class="bg-white border border-gray-100 shadow-sm overflow-hidden">
                        <div class="p-8 space-y-10 text-gray-700 leading-relaxed text-sm">
                            ...
                            <div class="border border-[#D4AF5A]/40 bg-[#F5F0E6] p-6 text-base text-[#0B1F3B]">
                                <i class="fas fa-bell text-[#D4AF5A] mr-2"></i>
