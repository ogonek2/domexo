...
@section('seo')
    <title>Гарантія — DOMEXO</title>
    <meta name="description" content="Гарантія та умови її надання в інтернет-магазині DOMEXO. Обмін і повернення протягом 14 днів, випадки відмови в гарантії.">
@endsection
    ...
    <section class="bg-[#F5F6FB] py-4">
        <div class="max-w-site mx-auto px-4 sm:px-6 lg:px-8">
            <nav class="flex items-center space-x-2 text-sm">
                ...
                <span class="text-[#0B1F3B] font-medium">Гарантія</span>
            </nav>
        </div>
    </section>
                ...
                <div class="lg:col-span-3">
                    <div class="bg-white border border-gray-100 shadow-sm overflow-hidden">
                        <div class="p-8 space-y-10 text-gray-700 leading-relaxed text-sm">
                            ...
                            <section>
                                <h2 class="font-heading text-2xl font-bold text-[#0B1F3B] mb-4 flex items-center gap-3">
                                    <span class="w-10 h-10 bg-[#0B1F3B] flex items-center justify-center shrink-0">
                                        <i class="fas fa-shield-alt text-[#D4AF5A]"></i>
                                    </span>
                            ...
                            <section>
                                <h2 class="font-heading text-xl font-bold text-[#0B1F3B] mb-4">Гарантія не надається, якщо:</h2>
                                <ul class="space-y-3">
                                    <li class="flex gap-3">
                                        <span class="text-[#D4AF5A] shrink-0 mt-0.5">—</span>
                            ...
                            <section>
                                <h2 class="font-heading text-xl font-bold text-[#0B1F3B] mb-4">Гарантійні зобов’язання не поширюються на такі несправності:</h2>
                                <ul class="space-y-3">
                                    <li class="flex gap-3">
                                        <span class="text-[#D4AF5A] shrink-0 mt-0.5">—</span>
