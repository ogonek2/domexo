...
@section('seo')
    <title>Політика конфіденційності — DOMEXO</title>
    <meta name="description" content="Політика конфіденційності інтернет-магазину DOMEXO. Захист персональних даних користувачів.">
@endsection
    ...
    <section class="bg-[#F5F6FB] py-4">
        <div class="max-w-site mx-auto px-4 sm:px-6 lg:px-8">
            <nav class="flex items-center space-x-2 text-sm">
                ...
                <span class="text-[#0B1F3B] font-medium">Політика конфіденційності</span>
            </nav>
        </div>
    </section>
                ...
                <div class="lg:col-span-3">
                    <div class="bg-white border border-gray-100 shadow-sm overflow-hidden">
                        <div class="p-8 space-y-10 text-gray-700 leading-relaxed text-sm">
                            ...
                            <p class="text-base">Ця Політика конфіденційності пояснює, як інтернет-магазин <strong>DOMEXO</strong> (далі — «ми», «наш сайт») збирає, використовує та захищає персональні дані користувачів (далі — «ви», «користувач») при відвідуванні та використанні сайту.</p>

                            <section>
                                <h2 class="font-heading text-xl font-bold text-[#0B1F3B] mb-4 flex items-center gap-3">
                                    <span class="w-8 h-8 bg-[#0B1F3B] flex items-center justify-center shrink-0"><i class="fas fa-info-circle text-[#D4AF5A] text-sm"></i></span>
                                    1. Збір інформації
                                </h2>
                            ...
                            <section>
                                <h2 class="font-heading text-xl font-bold text-[#0B1F3B] mb-4 flex items-center gap-3">
                                    <span class="w-8 h-8 bg-[#0B1F3B] flex items-center justify-center shrink-0"><i class="fas fa-cogs text-[#D4AF5A] text-sm"></i></span>
                            ...
                            <section>
                                <h2 class="font-heading text-xl font-bold text-[#0B1F3B] mb-4 flex items-center gap-3">
                                    <span class="w-8 h-8 bg-[#0B1F3B] flex items-center justify-center shrink-0"><i class="fas fa-shield-alt text-[#D4AF5A] text-sm"></i></span>
                            ...
                            <section>
                                <h2 class="font-heading text-xl font-bold text-[#0B1F3B] mb-4 flex items-center gap-3">
                                    <span class="w-8 h-8 bg-[#0B1F3B] flex items-center justify-center shrink-0"><i class="fas fa-users text-[#D4AF5A] text-sm"></i></span>
                            ...
                            <section>
                                <h2 class="font-heading text-xl font-bold text-[#0B1F3B] mb-4 flex items-center gap-3">
                                    <span class="w-8 h-8 bg-[#0B1F3B] flex items-center justify-center shrink-0"><i class="fas fa-cookie-bite text-[#D4AF5A] text-sm"></i></span>
                                    5. Cookies
                                </h2>
                            ...
                            <section>
                                <h2 class="font-heading text-xl font-bold text-[#0B1F3B] mb-4 flex items-center gap-3">
                                    <span class="w-8 h-8 bg-[#0B1F3B] flex items-center justify-center shrink-0"><i class="fas fa-external-link-alt text-[#D4AF5A] text-sm"></i></span>
                            ...
                            <section>
                                <h2 class="font-heading text-xl font-bold text-[#0B1F3B] mb-4 flex items-center gap-3">
                                    <span class="w-8 h-8 bg-[#0B1F3B] flex items-center justify-center shrink-0"><i class="fas fa-handshake text-[#D4AF5A] text-sm"></i></span>
                                    7. Згода
                                </h2>
                            ...
                            <section>
                                <h2 class="font-heading text-xl font-bold text-[#0B1F3B] mb-4 flex items-center gap-3">
                                    <span class="w-8 h-8 bg-[#0B1F3B] flex items-center justify-center shrink-0"><i class="fas fa-user-check text-[#D4AF5A] text-sm"></i></span>
                                    8. Права користувача
                                </h2>
                            ...
                            <section>
                                <h2 class="font-heading text-xl font-bold text-[#0B1F3B] mb-4 flex items-center gap-3">
                                    <span class="w-8 h-8 bg-[#0B1F3B] flex items-center justify-center shrink-0"><i class="fas fa-edit text-[#D4AF5A] text-sm"></i></span>
                                    9. Зміни до політики
                                </h2>
                            ...
                            <section>
                                <h2 class="font-heading text-xl font-bold text-[#0B1F3B] mb-4 flex items-center gap-3">
                                    <span class="w-8 h-8 bg-[#0B1F3B] flex items-center justify-center shrink-0"><i class="fas fa-phone text-[#D4AF5A] text-sm"></i></span>
                            ...
                            <div class="border border-[#D4AF5A]/40 bg-[#F5F0E6] p-6 text-center text-[#0B1F3B] text-sm">
                                Використовуючи сайт DOMEXO, ви погоджуєтесь з цією політикою конфіденційності.
                            </div>
