...
.wishlist-page__name a { color: #1E1E1E; text-decoration: none; }
.wishlist-page__name a:hover { color: #D4AF5A; }
.wishlist-page__price { font-weight: 700; color: #1E1E1E; font-family: Montserrat, sans-serif; margin: 0 0 0.75rem; }
...
.wishlist-page__view { background: #D4AF5A; color: #1E1E1E; }
.wishlist-page__view:hover { background: #C5A059; }
.wishlist-page__cart { background: #0B1F3B; color: #fff; }
...
.wishlist-page__remove:hover { border-color: #1E1E1E; color: #1E1E1E; }
...
.wishlist-page__empty h2 { font-family: Montserrat, sans-serif; font-size: 1.5rem; margin: 1rem 0 0.5rem; color: #0B1F3B; }
