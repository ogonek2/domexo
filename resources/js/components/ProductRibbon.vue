<template>
    <section class="product-ribbon bg-white py-12 md:py-16">
        <div class="mx-auto max-w-site px-4 sm:px-6 lg:px-8">
            <div class="mb-6 flex flex-wrap items-end justify-between gap-4">
                ...
                <a
                    :href="activeHref"
                    class="hidden items-center gap-1.5 text-sm font-semibold text-[#0B1F3B] transition-colors hover:text-[#D4AF5A] sm:inline-flex">
                    Дивитись усі
            ...
            <div v-else class="border border-gray-200 bg-[#F5F6FB] px-6 py-12 text-center text-sm text-slate-500">
                Товари цієї підбірки скоро з'являться
            </div>

            <div class="mt-6 text-center sm:hidden">
                <a :href="activeHref" class="inline-flex items-center gap-1.5 text-sm font-semibold text-[#0B1F3B]">
                    Дивитись усі
                    <AppIcon name="arrow-right" :size="16" />
                </a>
            </div>
